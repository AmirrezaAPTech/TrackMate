...
const SpecificationsCard: React.FC<SpecificationsCardProps> = ({ imgUrl, title }) => {
  ...
  return (
    <div ref={cardRef} className="w-[280px] sm:w-[400px] sm:h-[170.38px] bg-[#222323] rounded-2xl flex flex-col items-start justify-center p-4 gap-4 shadow-2xl shadow-black max-sm:text-center cart-animation-right">
